...
![Pharma-Sync Header](https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=1200&q=80)

[![React](https://img.shields.io/badge/Frontend-React%20v18.3-61DAFB?logo=react&logoColor=black&style=for-the-badge)](https://react.dev/) [![Vite](https://img.shields.io/badge/Compilador-Vite%20v5-646CFF?logo=vite&style=for-the-badge)](https://vite.dev/) [![BaaS](https://img.shields.io/badge/Backend-Supabase%20%28PostgreSQL%29-3ECF8E?logo=supabase&style=for-the-badge)](https://supabase.com) [![Render Deployment](https://img.shields.io/badge/Despliegue-Render.com-00E5FF?logo=render&style=for-the-badge)](https://render.com) [![Styling](https://img.shields.io/badge/Estilos-CSS3%20Vanilla%20y%20Glassmorphism-FF4081?style=for-the-badge)](https://developer.mozilla.org/css) [![License](https://img.shields.io/badge/Licencia-MIT-4CAF50?style=for-the-badge)](LICENSE)

---

## 🌐 Acceso al Sistema Desplegado

> **URL de Producción:** [https://odoo-erp-njfn.onrender.com](https://odoo-erp-njfn.onrender.com)

---

## 🔑 Credenciales de Acceso al Sistema

El acceso al ERP está protegido por perfiles de usuario con roles diferenciados. Utilice las siguientes credenciales para ingresar:
...
> 💡 **Recomendación:** Para una experiencia completa del sistema, ingrese con el usuario `admin` / `admin999` que tiene acceso a todos los módulos.
...
│   │   │   ├── Layout.jsx         # Frame principal del ERP: Sidebar, Header, alertas de red
│   │   │   ├── Login.jsx          # UI y validación de credenciales del personal
│   │   │   └── MobileFrame.jsx    # Simulador responsivo táctil
│   │   ├── context/               # Lógica del motor del ERP y sincronización de datos
│   │   │   └── AppContext.jsx     # Contexto global, persistencia híbrida e integración Cloud
│   │   ├── modules/               # Módulos funcionales de la suite (12 directorios)
│   │   │   ├── CRM/               # Leads, segmentación clínica y Kanban interactivo
│   │   │   ├── Compras/           # Proveedores nacionales e ingreso físico de lotes
│   │   │   ├── Contabilidad/      # Balance general e integración IA bancaria
│   │   │   ├── Inventario/        # Semáforos de stock y fechas de vencimiento
│   │   │   ├── Manufactura/       # MRP y recetas farmacéuticas magistrales
│   │   │   ├── Marketing/         # Envío simulado de SMS/Email
│   │   │   ├── MesaAyuda/         # Helpdesk con soporte médico y SLA
│   │   │   ├── POS/               # Punto de Venta táctil
│   │   │   ├── Proyectos/         # Diagrama Gantt y tareas
│   │   │   ├── RRHH/              # Personal y asistencia
│   │   │   ├── SitioWeb/          # E-Commerce y chat virtual
│   │   │   └── Ventas/            # Cotizaciones y facturación mayorista
│   │   ├── App.css                # Estilos globales
│   │   ├── App.jsx                # Enrutador principal
│   │   ├── index.css              # Tokens de diseño CSS
│   │   └── main.jsx               # Renderizador principal del DOM
...
1. Inicie sesión en el sistema usando cualquiera de las credenciales de rol descritas arriba.
...
Desarrollado para **Pharma-Sync Suite** — El estándar del futuro en la gestión farmacéutica moderna.
